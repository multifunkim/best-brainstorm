function [scores, OPTIONS] = be_wmsp(M, Gstruct, OPTIONS)
%   BE_MSP returns a vector of MSP scores as proposed by Mattout(2005).
%   It is adapted here for the wavelet representation of the data
%
...
OPTIONS.clustering.NEW.weight_alpha = Op * Mn;
