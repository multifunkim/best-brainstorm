function [ template ] = be_template(structureName)
% be_template: Defines a template structure for all the Brainstorm data types.
% Copy of brainstorm db_template
% USAGE :  [template] = be_template(structureName);
...
switch lower(structureName)
    ...
    case 'datamat'
        template = struct('F',            [], ...
                          ...
                          'nAvg',         1, ...
                          'Leff',         1, ...
                          'Events',       repmat(be_template('event'), 0), ...
                          'ColormapType', [], ...
                          'DisplayUnits', [], ...
                          'History',      []);
    case 'noisecovmat'
    ...
    case 'subject'
        template = struct(...
              ...
              'FileName',            '', ...
              'DateOfAcquisition',   '', ...
              'Anatomy',             repmat(be_template('Anatomy'),0), ...
              'Surface',             repmat(be_template('Surface'),0), ...
              'iAnatomy',            [], ...
              'iScalp',              [], ...
              'iCortex',             [], ...
              'iInnerSkull',         [], ...
    ...
    case 'study'
         template = struct(...
              ...
              'Channel',             struct(...  
                  ...
                  'DisplayableSensorTypes', {}), ...
              'iChannel',            [], ...
              ... repmat(be_template('Data'),0)
              'Data',              struct(...
                  'FileName',        {}, ...
                  'Comment',         {}, ...
                  'DataType',        {}, ...
                  'BadTrial',        {}), ...
              ... repmat(be_template('HeadModel'),0)
              'HeadModel',         struct(...
                  'FileName',         {}, ...
                  'HeadModelType',    {}, ...
                  'MEGMethod',        {}, ...
              ...
              'Stat',                struct(...
                  ...
                  'pThreshold',      {}, ...
                  'DataFile',        {}), ...
              ... repmat(be_template('Image'),  0)
              'Image',               struct(...
                  'FileName',        {}, ...
                  'Comment',         {}), ...
              ... repmat(be_template('noiseCov'), 0)
              'NoiseCov',            struct(...
                  'FileName',        {}, ...
                  'Comment',         {}), ...
              ... repmat(be_template('Dipoles'), 0)
              'Dipoles',             struct(...
                  'FileName',        {}, ...
                  'Comment',         {}, ...
                  'DataFile',        {}), ...
              ... repmat(be_template('Timefreq'),  0)
              'Timefreq',            struct(...
                  'FileName',        {}, ...
                  'Comment',         {}, ...
                  'DataFile',        {}, ...
                  'DataType',        {}), ...
              ... repmat(be_template('Matrix'),  0)
              'Matrix',             struct(...
                  'FileName',        {}, ...
                  'Comment',         {}));
    ...
    case 'protocolsubjects' 
        template = struct(...
            'Subject',        repmat(be_template('Subject'), 0), ...
            'DefaultSubject', []);
        
    case 'protocolstudies'
        template = struct(...
            'Study',         repmat(be_template('Study'), 0), ...
            'DefaultStudy',  be_template('Study'), ...
            'AnalysisStudy', be_template('Study'));
    ...
    case 'sfile'
        template = struct(...
            ...
            'epochs',      repmat(be_template('epoch'), 0), ...
            'events',      repmat(be_template('event'), 0), ...
            'header',      [], ...
            'channelflag', [], ...
            'acq_date',    []);
    ...
    case 'dataset'
        template = struct(...
            ...
            'SubjectFile', '', ...
            'ChannelFile', '', ...
            'Surfaces',    repmat(be_template('LoadedSurface'), 0), ...
            'Measures',    be_template('Measures'), ...
            'Results',     repmat(be_template('LoadedResults'), 0), ...
            'Dipoles',     repmat(be_template('LoadedDipoles'), 0), ...
            'Timefreq',    repmat(be_template('LoadedTimefreq'), 0), ...
            'Matrix',      repmat(be_template('LoadedMatrix'), 0), ...
            'Channel',     repmat(be_template('ChannelDesc'), 0), ...
            'MegRefCoef',  [], ...
            'Projector',   repmat(be_template('Projector'), 0), ...
            'Clusters',    repmat(be_template('Cluster'), 0), ...
            'IntraElectrodes', repmat(be_template('IntraElectrode'), 0), ...
            'isChannelModified', 0, ...
            'HeadPoints',  [], ...
            'Figure',      repmat(be_template('Figure'), 0));
    ...
    case 'atlas'
        template = struct(...
            'Name',   'User scouts', ...
            'Scouts', repmat(be_template('Scout'), 0));
...
%             'Region',     'UU');   % 1st letter: Left/Right/Unknown,  2nd letter: Frontal/Parietal/Temporal/Occipital/Central/Unkown
    ...
    case 'globaldata'
        template = struct(...
            ...
            'DataBase', struct(...
                ...
                'Searches',           struct(...
                    'iActive', 0, ...
                    'Active',  repmat(be_template('ActiveSearch'), 0), ...
                    'All',     repmat(struct(...
                        'Name',      '', ...
                        'Search',    []), 0))), ...
            'DataSet',  repmat(be_template('DataSet'), 0), ...
            'Mri',      repmat(be_template('LoadedMri'), 0), ...
            'Surface',  repmat(be_template('LoadedSurface'), 0), ...
            'Fibers',      repmat(be_template('LoadedFibers'), 0), ...
            ...
            'HeadModeler',    struct(...
             ...
             'ChannelMontages', struct(...
                 ...
                 'Montages', repmat(be_template('Montage'), 0)), ...
             'Processes', struct( ...
                 'All',       [], ...
                 'Current',   [], ...
    ...
    case 'searchnode'
        template = struct(...
            'Type',     0, ...
                ... % 0 = null
                ... % 1 = be_template('SearchParam') value
