function [Results, OPTIONS] = be_main_call_NIRS(HeadModel, OPTIONS)
...
%     end
    ...
    [Results, MEMoptions]   = feval(['be_' lower(MEMoptions.mandatory.pipeline) '_solver_NIRS'], HeadModel, MEMoptions, Results );
