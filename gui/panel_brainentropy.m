...
%     end
    ...
    jTxtVCOV  = JTextField( num2str(OPTIONS.solver.NoiseCov_method) );
        ...
        jTxtVCOV.setToolTipText(... 
            ['<HTML><B>Sensors noise covariance matrix</B>:<BR>' ...
             '0 = identity matrix<BR>' ...
             '1 = diagonal (same variance along diagonal)<BR>' ...
             '2 = diagonal<BR>' ...
             '3 = full<BR>' ...
             '4 = wavelet-based estimation (same variance along diagonal, scale j=1 of the discrete wavelet transform)<BR>' ...
             '5 = wavelet-based + scale-adaptvive(same variance along diagonal, different mat. for each scale of the signal, same for each sensors)<BR>'...
