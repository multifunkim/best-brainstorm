...
if ~OPTIONS.automatic.stand_alone
    TFf     =   load( fullfile(OPTIONS.automatic.iProtocol.STUDIES, OPTIONS.automatic.DataInfo.TFfile), 'Options' );
else
...
TMbin   =   bst_closest(OPTIONS.optional.TimeSegment([1 end]), OPTIONS.mandatory.DataTime);
