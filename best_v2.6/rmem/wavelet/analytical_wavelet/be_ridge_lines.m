...
% time stamps
Tlims       =   bst_closest( OPTIONS.optional.BaselineSegment([1 end]), OPTIONS.mandatory.DataTime );
...
% Get time stamps
Tlims       =   bst_closest( OPTIONS.optional.TimeSegment([1 end]), OPTIONS.mandatory.DataTime );
SLICE       =   SCALO(:,Tlims(1):Tlims(2));
