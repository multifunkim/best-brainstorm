...
if isfield(OPTIONS, 'temporary') && isfield(OPTIONS.temporary, 'timeSMP')
    ...
    timeSMP     =   bst_closest(OPTIONS.optional.TimeSegment([1 end]), OPTIONS.mandatory.DataTime);
...
if isfield(OPTIONS, 'temporary') && isfield(OPTIONS.temporary, 'frqSMP')
    ...
    frqSMP      =   bst_closest( OPTIONS.ridges.frequency_range, OPTIONS.wavelet.freqs_analyzed );
