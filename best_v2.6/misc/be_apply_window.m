...
% ------------------------------------------------------------------------- 
    ...
    % Data
    DTs = bst_closest( OPTIONS.optional.TimeSegment(1), OPTIONS.mandatory.DataTime );
    DTn = bst_closest( OPTIONS.optional.TimeSegment(end), OPTIONS.mandatory.DataTime );
    
    % Baseline
    BSs = bst_closest( OPTIONS.optional.BaselineSegment(1), OPTIONS.optional.BaselineTime );
    BSn = bst_closest( OPTIONS.optional.BaselineSegment(end), OPTIONS.optional.BaselineTime );
